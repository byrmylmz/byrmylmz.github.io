        ...
        <ul class="flex items-center space-x-2">
          <li>
            <theme-switcher :theme="theme" @themeChanged="updateTheme" />
              ...
              <li>
            <a href="mailto:me@example.com" class="text-black hover:text-gray-400">
          ...
          <li>
            <a href="https://www.youtube.com/channel/UCmaSA9hVbB64W-GHWN9uO7A" target="_blank" class="text-black hover:text-gray-600">
          ...
          <li>
            <a href="https://github.com/byrmylmz" target="_blank" class="text-black hover:text-gray-600">
          ...
          <li>
            <a href="https://twitter.com/byrmylmz61" target="_blank" class="text-black hover:text-gray-600">
          ...
          <li>
            <a href="https://www.instagram.com/byrm.ylmz61/" target="_blank" class="text-black hover:text-gray-600">
